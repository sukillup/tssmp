...
@app.route('/')
def he():
    return render_template('ccca.html',message="パーカーの見積")
...
@app.route('/sa')
def sa():
    return render_template('sssa.html',message="パーカー項目")
...
def ddda():
    ...
    if neme1=="S" and neme2 and neme3=="自前" and neme4=="ワンポイント":
     ...
     return render_template("ddda.html",message="パーカー{0}サイズ{1}{2}{3}{4}枚".format(neme1,neme2,neme3,neme4,neme5),tist="合計で",tist2="{}円です".format(total))
